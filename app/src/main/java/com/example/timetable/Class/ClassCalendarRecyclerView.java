...
public class ClassCalendarRecyclerView extends RecyclerView.Adapter<ClassCalendarRecyclerView.ViewHolder>{

    private static final String TAG = "Class Calendar Recycler View";
    ...
    public ClassCalendarRecyclerView(ArrayList<String> className, ArrayList<String> teacher, ArrayList<String> venue, ArrayList<String> sTime, ArrayList<String> eTime, ArrayList<String> sdate, ArrayList<Integer> ids, ArrayList<Integer> color, Context mContext) {
    ...
    @NonNull
    @Override
    public ClassCalendarRecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view =
                LayoutInflater.from(parent.getContext()).inflate(R.layout.class_calendar_list,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.sdate.setText(sdate.get(position));
